...
const PhotoRestorationServices = () => {
  const pdata = [
    {
      id: 1,
      title: "Photo Restoration Services",
      description: [
        "Restore old and damaged photos to their former glory with our photo restoration services.",
        "Our experts will repair scratches, tears, and discoloration, giving new life to your cherished memories.",
        "Preserve your valuable photographs and relive the moments with our photo restoration services.",
        "Bring back the clarity, color, and detail of your vintage or damaged photos.",
        "Reconnect with the past and revive the emotions captured in your treasured photographs.",
      ],
    },
  ];
  return (
    <div className="banner" style={{}}>
          ...
          <Row>
            <Col lg={6} className="text-center mb-4 mt-5">
              ...
              <p style={{ fontWeight: "600", color: "#ffffff" }}>
                This is our image restoration service comes into play as we are
                able to restore and rejuvenate damaged, distorted, and even
                ripped images so, please contract with us. You will get 24/7-365
                days support.
              </p>
      ...
      <div className="descriptions mt-5 mb-5">
        ...
        >
          PROFESSIONAL PHOTO RESTORATION <br /> SERVICES
        </h1>
...
export default PhotoRestorationServices;
