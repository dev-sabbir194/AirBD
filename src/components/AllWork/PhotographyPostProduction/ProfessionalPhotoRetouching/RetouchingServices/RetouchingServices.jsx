  ...
  const pdata = [
    {
      ...
      description: [
        "Achieve flawless skin, remove blemishes, and enhance facial features with our professional photo retouching services.",
        "Our skilled retouchers will bring out the best in your portraits, ensuring a polished and natural look.",
        "Transform your images and make them stand out with our expert photo retouching.",
        "Get stunning and flawless results with our professional retouching services.",
        "Highlight the beauty and essence of your subjects through expert retouching and enhancement.",
      ],
    },
  ];
  return (
    <div className="banner" style={{}}>
          ...
          <Row>
            <Col lg={6} className="text-center mb-4 mt-5">
              ...
              <p style={{ fontWeight: "600", color: "#ffffff" }}>
                ...
                professionally, also any retouch and color correction you want.
                model retouch and color correction, product retouch and color
                correction, jewelry retouch and color correction, Commercial
                Photo retouch and color correction, ETC. You will get 24/7-365
                days support.
              </p>
      ...
      <div className="descriptions mt-5 mb-5">
        ...
        >
          PROFESSIONAL PHOTO RETOUCHING <br /> SERVICES
        </h1>
